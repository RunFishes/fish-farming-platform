<template>
	<div class="p-6">
		...
		<div class="mt-3 flex flex-wrap">
			...
			<div class="w-1/3 text-center text-slate-400 text-sm">
				鲈鱼：<span ref="city2" class="text-[#5DC5EF] text-3xl font-[Electronic]">8,778,988</span>
			</div>
			<div class="w-1/3 text-center text-slate-400 text-sm">
				石斑鱼；<span ref="city3" class="text-[#5DC5EF] text-3xl font-[Electronic]">8,778,988</span>
			</div>
			<div class="w-1/3 text-center text-slate-400 text-sm">
				草鱼：<span ref="city4" class="text-[#5DC5EF] text-3xl font-[Electronic]">8,778,988</span>
			</div>
			<div class="w-1/3 text-center text-slate-400 text-sm">
				鲤鱼：<span ref="city5" class="text-[#5DC5EF] text-3xl font-[Electronic]">8,778,988</span>
			</div>
			<div class="w-1/3 text-center text-slate-400 text-sm">
				鲫鱼：<span ref="city6" class="text-[#5DC5EF] text-3xl font-[Electronic]">8,778,988</span>
			</div>
		</div>
	</div>
</template>
